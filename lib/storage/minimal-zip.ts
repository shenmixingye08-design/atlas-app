/**
 * Minimal store-only ZIP builder for integrity / durability fixtures.
...
export function minimalDocx(): Buffer {
...
export function minimalPptx(): Buffer {
  return buildStoredZip([
    { name: "[Content_Types].xml", content: "<Types/>" },
    { name: "_rels/.rels", content: "<Relationships/>" },
...
export function minimalCsv(): Buffer {
  return Buffer.from("name,amount\nA,100\nB,200\n", "utf8");
}
