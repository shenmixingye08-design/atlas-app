...
export function buildSectionedWriterPrompt(input: {
  ...
  return [
    ...
    "Read the Knowledge Engine Context Pack fully before writing. Do not invent from zero.",
    ...
    "- Apply brand / writing / design / deliverable knowledge from the Context Pack.",
