/**
 * Inline SQL so Production serverless can apply schema even when
 * supabase/migrations is not present in the deploy artifact.
 * Mirrors supabase/migrations/20260713_atlas_billing_subscriptions.sql
 */
export const ATLAS_BILLING_SUBSCRIPTIONS_MIGRATION_SQL = `
