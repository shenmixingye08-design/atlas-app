...
const CASES: Case[] = [
  ...
  },
  {
    ...
    assignment: "この領収書を家計簿にしてください",
    expectType: "receipt_voucher",
    expectFormats: ["xlsx"],
  },
  {
    name: "施工写真",
    label: "CONSTRUCTION PHOTO",
    assignment: "この施工写真を報告書Wordにしてください",
    expectType: "construction_photo",
    expectFormats: ["docx"],
  },
  {
    name: "議事録",
    label: "MEETING MINUTES",
    assignment: "この会議写真を議事録Wordにしてください",
    expectType: "meeting_minutes",
    expectFormats: ["docx"],
  },
  {
    name: "写真",
