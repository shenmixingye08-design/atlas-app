...
export const CAPABILITY_REGISTRY: readonly CapabilityDefinition[] = [
  ...
  },
  {
    id: "google_drive",
    name: "Google Drive",
    description: "Google Drive保存",
    riskLevel: "medium",
    handlerKind: "external_integration",
    requiredFeatureFlag: "google",
    requiredConnector: "google",
    systemRequiresApproval: false,
    invokeContract: "connectors.google.drive",
    enabled: true,
  },
  {
    id: "line_notify",
    name: "LINE通知",
    description: "LINE Messaging 通知",
    riskLevel: "medium",
    handlerKind: "external_integration",
    requiredFeatureFlag: null,
    requiredConnector: "line",
    systemRequiresApproval: false,
    invokeContract: "connectors.line.notify",
    enabled: true,
  },
  {
    id: "slack",
    ...
    systemRequiresApproval: false,
    invokeContract: "connectors.slack.send",
    enabled: true,
  },
  {
    id: "discord",
    name: "Discord",
    description: "Discord送信",
    riskLevel: "medium",
    handlerKind: "external_integration",
    requiredFeatureFlag: null,
    requiredConnector: "discord",
    systemRequiresApproval: false,
    invokeContract: "connectors.discord.send",
    enabled: true,
  },
  {
    id: "notion",
    name: "Notion",
    description: "Notion作成・更新",
    riskLevel: "medium",
    handlerKind: "external_integration",
    requiredFeatureFlag: null,
    requiredConnector: "notion",
    systemRequiresApproval: false,
    invokeContract: "connectors.notion.write",
    enabled: true,
  },
  {
    id: "notify",
