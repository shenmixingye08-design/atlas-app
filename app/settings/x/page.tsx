...
import { XConnectionSettings } from "@/components/settings/x-connection-settings";
import { LoadingState } from "@/components/ui/loading-state";
import { ui } from "@/lib/i18n";

export const metadata: Metadata = {
  title: ui.metadata.xSettings,
  description: ui.xSettings.subtitle,
};
