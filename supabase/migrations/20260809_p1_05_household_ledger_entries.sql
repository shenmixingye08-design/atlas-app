...
-- Replaces atlas_user_state JSON / process memory / 40-entry compact as SoT for ledger lines.
-- SAFE: additive only. Does not drop or rewrite atlas_user_state.
-- Service role writes; anon/authenticated denied via RLS.
