...
-- Replaces process-local Maps that do not aggregate across serverless instances.
...
-- Atomic consume: fixed window aligned to epoch. Returns allowed/remaining/retry_after_ms.
